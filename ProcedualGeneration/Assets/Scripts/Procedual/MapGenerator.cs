...
public class MapGenerator : MonoBehaviour
{
    ...
    public void DrawMapInEditor()
    {
        ...
        {
            display.DrawMesh(MeshGenerator.GenerateTerrainMesh(mapData.heightMap, terrainData.meshHeightMultipier, terrainData.meshHeightCurve, editorPreviewLOD
    ...
    {
        MeshData meshData = MeshGenerator.GenerateTerrainMesh(mapData.heightMap, terrainData.meshHeightMultipier, terrainData.meshHeightCurve, lod, terrainData.useFlatShading);
